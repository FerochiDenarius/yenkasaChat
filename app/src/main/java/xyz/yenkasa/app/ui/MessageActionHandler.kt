// File: app/src/main/java/xyz.yenkasa.appchat/ui/MessageActionHandler.kt
package xyz.yenkasa.app.ui // Should match your package structure
...
import xyz.yenkasa.app.R // Ensure this import is correct for your project
...
class MessageActionHandler(
    ...
    fun showPopupMenu(message: ChatMessage, anchorView: View, positionInAdapter: Int) {
        ...
        val isOwnMessage = message.sender?._id == currentUserId || message.senderId == currentUserId
        deleteItem?.isVisible = isOwnMessage
        editItem?.isVisible = isOwnMessage && !message.text.isNullOrBlank()
