...
/*
 * This router is expected to be mounted at '/api' in your main server file (e.g., app.js or server.js)
 * Example: const oneSignalRoutes = require('./routes/onesignal');
 * app.use('/api', oneSignalRoutes);
 */

// --- Route for Android App to Update Player ID ---
// This route will handle: PATCH /api/users/:userId/player-id
